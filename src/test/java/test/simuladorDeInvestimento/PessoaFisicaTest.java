...
public class PessoaFisicaTest extends BaseTest {

    @Test()
    public void deveriaAplicarDuranteAnos() {
        SimuladorPage simulador = new SimuladorPage(driver);
        simulador.paraVoce().aplicarInicialmente("20.00").investindoMensalmente("100.00").durante("12").anos().simular();
    ...
    public void deveriaAplicarDuranteMeses() {
        SimuladorPage simulador = new SimuladorPage(driver);
        simulador.paraVoce().aplicarInicialmente("20.00").investindoMensalmente("100.00").durante("12").meses().simular();
        String resultadoObtido = simulador.resultadoSimulacao();
